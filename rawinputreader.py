...
class rawinputreader:
    ...
    def pollEvents(self):
        ...
        PM_REMOVE = 1
        #a = windll.user32.PeekMessageA(pMsg, self.hwnd, 0, 0, PM_REMOVE)
        #print(a)
...
if __name__=='__main__':
    ...
    print(sizeof(RAWINPUTHEADER))
    print(sizeof(RAWMOUSE))
    rir.stop()   